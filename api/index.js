...
// Usaremos a chave hardcoded por enquanto, mas adicionaremos um aviso.
const API_KEY = 'sk_live_EBKYpl0XppoRJSr1sHv9oiQzO9qrMSC2pUnt0lQBUJVP Sxb4:c4458e78-0de1-4f5d-8814-907ee1638e72';
...
module.exports = async (req, res) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            const errorMsg = data.message || `Erro HTTP ${response.status} na API externa.`;
